"""
VPSI-TRUTH --- modules/realidad/conocimiento_humano/tecnologia.py

Disciplina: tecnologia (categoría conocimiento_humano / bloque ingenieria_tecnologia).
...
FUNCION = {
    "nombre": "tecnologia",
    "hace": (
        "Traer y etiquetar material tecnológico aplicado (sistemas, estándares, documentación); "
        "pedir evaluación a Engine bajo el O de esta disciplina; "
        "aprobar o rechazar el material antes de que suba."
    ),
    "provee": [
        "material_etiquetado_tecnologia",
        "peticion_evaluacion_engine",
        "aprobacion_dominio",
    ],
    "categoria": "conocimiento_humano",
    "bloque": "ingenieria_tecnologia",
    "pide_evaluacion_engine": True,
    "requiere_aprobacion_dominio": True,
    "o_evaluacion": (
        "Contraste de material tecnológico: sistemas, estándares y documentación técnica. "
