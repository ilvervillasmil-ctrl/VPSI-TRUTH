"""
VPSI-TRUTH --- modules/realidad/conocimiento_humano/ciencias_tierra.py

Disciplina: ciencias_tierra (categoría conocimiento_humano / bloque naturales).
...
FUNCION = {
    "nombre": "ciencias_tierra",
    "hace": (
        "Traer y etiquetar material de ciencias de la Tierra y ambiente; "
        "pedir evaluación a Engine bajo el O de esta disciplina; "
        "aprobar o rechazar el material antes de que suba."
    ),
    "provee": [
        "material_etiquetado_ciencias_tierra",
        "peticion_evaluacion_engine",
        "aprobacion_dominio",
    ],
    ...
    "o_evaluacion": (
        "Contraste de material de ciencias de la Tierra: geología, clima, océanos, ambiente. "
        "Candidato a K bajo este O; no es ancla de R."
    ),
}

DOMINIO = "ciencias_tierra"
