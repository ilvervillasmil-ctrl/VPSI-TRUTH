"""
VPSI-TRUTH --- modules/realidad/conocimiento_humano/ingenieria.py

Disciplina: ingenieria (categoría conocimiento_humano / bloque ingenieria_tecnologia).
...
FUNCION = {
    "nombre": "ingenieria",
    "hace": (
        "Traer y etiquetar material de ingeniería (diseño, sistemas, normas técnicas); "
        "pedir evaluación a Engine bajo el O de esta disciplina; "
        "aprobar o rechazar el material antes de que suba."
    ),
    "provee": [
        "material_etiquetado_ingenieria",
        "peticion_evaluacion_engine",
        "aprobacion_dominio",
    ],
    ...
    "o_evaluacion": (
        "Contraste de material de ingeniería: diseños, especificaciones y normas. "
