"""
VPSI-TRUTH --- modules/realidad/conocimiento_humano/biologia.py

Disciplina: biologia (categoría conocimiento_humano / bloque naturales).
...
FUNCION = {
    ...
    "o_evaluacion": (
        "Contraste de material biológico: organismos, sistemas vivos y evidencia experimental. "
