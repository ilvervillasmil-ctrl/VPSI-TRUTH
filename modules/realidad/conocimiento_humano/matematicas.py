"""
VPSI-TRUTH --- modules/realidad/conocimiento_humano/matematicas.py

Disciplina: matematicas (categoría conocimiento_humano / bloque formales).
...
FUNCION = {
    "nombre": "matematicas",
    "hace": (
        "Traer y etiquetar material matemático (definiciones, teoremas, demostraciones, notación); "
        "pedir evaluación a Engine bajo el O de esta disciplina; "
        "aprobar o rechazar el material antes de que suba."
    ),
    "provee": [
        "material_etiquetado_matematicas",
        "peticion_evaluacion_engine",
        "aprobacion_dominio",
    ],
    ...
    "o_evaluacion": (
        "Contraste de material matemático como representación formal: definiciones, demostraciones y notación. "
