"""
VPSI-TRUTH --- modules/realidad/conocimiento_humano/salud.py

Disciplina: salud (categoría conocimiento_humano / bloque medicas).
...
FUNCION = {
    ...
    "o_evaluacion": (
        "Contraste de material de salud: epidemiología, salud pública y evidencia poblacional. "
