"""
VPSI-TRUTH --- modules/realidad/conocimiento_humano/medicina.py

Disciplina: medicina (categoría conocimiento_humano / bloque medicas).
...
FUNCION = {
    ...
    "o_evaluacion": (
        "Contraste de material médico: evidencia clínica, mecanismos y guías. "
