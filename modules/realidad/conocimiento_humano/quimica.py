"""
VPSI-TRUTH --- modules/realidad/conocimiento_humano/quimica.py

Disciplina: quimica (categoría conocimiento_humano / bloque naturales).
...
FUNCION = {
    ...
    "o_evaluacion": (
        "Contraste de material químico: sustancias, reacciones y propiedades declaradas. "
