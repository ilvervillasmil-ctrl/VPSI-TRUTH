"""
VPSI-TRUTH --- modules/realidad/conocimiento_humano/logica.py

Disciplina: logica (categoría conocimiento_humano / bloque formales).
...
FUNCION = {
    "nombre": "logica",
    "hace": (
        "Traer y etiquetar material de lógica (sistemas formales, inferencia, metalógica); "
        "pedir evaluación a Engine bajo el O de esta disciplina; "
        "aprobar o rechazar el material antes de que suba."
    ),
    "provee": [
        "material_etiquetado_logica",
        "peticion_evaluacion_engine",
        "aprobacion_dominio",
    ],
    ...
    "o_evaluacion": (
        "Contraste de material lógico: sistemas formales, reglas de inferencia y consistencia declarada. "
